...
class ProjectEntity(object):
    ...
    def __init__(self, id=None, name=None, comment=None, visible=None, order_number=None, order_date=None, start=None, end=None, color=None, budget=None, time_budget=None, teams=None, customer=None, meta_fields=None):  # noqa: E501
