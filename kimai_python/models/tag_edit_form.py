...
class TagEditForm(object):
    ...
    @property
    def name(self):
        """Gets the name of this TagEditForm.  # noqa: E501

        The tag name (forbidden character: comma)  # noqa: E501

        :return: The name of this TagEditForm.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TagEditForm.

        The tag name (forbidden character: comma)  # noqa: E501

        :param name: The name of this TagEditForm.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TagEditForm, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TagEditForm):
            return False
