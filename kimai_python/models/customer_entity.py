...
class CustomerEntity(object):
    ...
    def __init__(self, id=None, name=None, number=None, comment=None, visible=None, company=None, vat_id=None, contact=None, address=None, country=None, currency=None, phone=None, fax=None, mobile=None, email=None, homepage=None, timezone=None, budget=None, time_budget=None, meta_fields=None, teams=None, color=None):  # noqa: E501
    ...
    def vat_id(self, vat_id):
        ...
        :type: str
        """
        if vat_id is not None and len(vat_id) > 50:
            raise ValueError("Invalid value for `vat_id`, length must be less than or equal to `50`")  # noqa: E501
