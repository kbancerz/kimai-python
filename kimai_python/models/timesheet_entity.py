...
class TimesheetEntity(object):
    ...
    def __init__(self, activity=None, project=None, user=None, tags=None, id=None, begin=None, end=None, duration=None, description=None, rate=None, internal_rate=None, fixed_rate=None, hourly_rate=None, exported=None, meta_fields=None):  # noqa: E501
